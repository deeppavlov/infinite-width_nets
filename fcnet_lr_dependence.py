...
def get_log_dir():
    log_dir = os.path.join(
        'results', 'lr_dependence', '{}_{}'.format(args.dataset, args.train_size), 
        ...
        for ref_width in ref_widths:
            ...
            for correction_epoch in (correction_epochs if scaling_mode.startswith('mean_field') else [None]):
                ...
                for width_factor in width_factors:
                    if width_factor == 1 and scaling_mode != 'default':
                        continue
                    ...
                    for log10_lr_factor in log10_lr_factors:
                        ...
                        for seed in range(args.num_seeds):
                            ...
                            print('width_factor = {}'.format(width_factor))
                            ...
                            results_all[scaling_mode][ref_width][correction_epoch][width_factor][log10_lr_factor][seed] = copy(results)
